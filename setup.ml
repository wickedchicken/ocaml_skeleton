...
(* OASIS_START *)
(* DO NOT EDIT (digest: c3b1972c8cf77b85c8887b19d49bb790) *)
(*
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_calc", []))];
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Mike Stipicevic"];
          homepage = None;
          synopsis = "A basic OCaml project with unit tests";
          description = None;
          categories = [];
            ...
            [
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/wickedchicken/ocaml_skeleton.git";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Run tests";
               ...
               Test
                 ({
                     ...
                     },
                   {
                      ...
                      test_tools = [InternalExecutable "test_calc"];
                      })
            ];
          plugins =
            [
